...
public class VentaService implements IVentaService{
	...
	public void saveVenta(Venta venta) {
		// le pasamos la lista de producto para que verifique si hay ca
		List<Producto>Lispro = venta.getListaProductos();
		pro.actualizarCantidadProduc(Lispro);
	...
	public boolean deleteventa(Long id) {
	    if (venta.existsById(id)) {
	        venta.deleteById(id);
	        return true; // Se eliminó la venta correctamente
	    }
	    return false; // No se encontró la venta con el ID especificado
	}
